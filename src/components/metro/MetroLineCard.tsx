...
export const MetroLineCard: React.FC<MetroLineCardProps> = ({ lineName, stationCount }) => {
  ...
  return (
    <div className="bg-ivory-surface rounded-2xl border border-ivory-border overflow-hidden shadow-warm-sm hover:shadow-warm-md transition-all duration-300 flex flex-col justify-between group">
      ...
      <div className="p-5 flex-1 flex flex-col justify-between">
        <div className="space-y-3">
          {/* Terminals */}
          <div className="flex items-center space-x-2 text-xs font-semibold text-charcoal bg-stone-50 p-2.5 rounded-xl border border-stone-100">
          ...
          <div className="flex items-center justify-between text-xs text-charcoal-muted pt-1">
            <div className="flex items-center space-x-1.5">
              ...
              <span className="font-medium text-charcoal-soft">{meta.status}</span>
            </div>
            {stationCount !== undefined && (
              <span className="bg-ivory-muted px-2 py-0.5 rounded-md text-[11px] font-semibold text-charcoal-soft">
