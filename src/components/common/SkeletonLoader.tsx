...
export const PandalCardSkeleton: React.FC = () => {
  return (
    <div className="bg-ivory-surface rounded-2xl border border-ivory-border overflow-hidden animate-pulse">
      <div className="w-full h-44 bg-stone-200/70" />
      <div className="p-5 space-y-3">
        <div className="h-4 bg-stone-200 rounded w-2/3" />
        <div className="h-3 bg-stone-200 rounded w-1/2" />
        <div className="h-3 bg-stone-200 rounded w-full" />
        <div className="pt-3 border-t border-ivory-muted flex justify-between">
